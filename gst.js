...
const gstQuestions = [
  {
    ...
    options: ["Reduction in Rural-Urban Drifts", "Increase in Foreign Debt", "Employment Opportunities", "Economic Development"],
  ...
  },
  {
    ...
    options: ["Export focused", "Capital intensive", "Government owned", "Labour intensive"],
  ...
  },
  {
    ...
    options: ["Casson's Economic Theory", "Knight Risk-bearing Theory", "Schumpeter's Innovation Theory", "Weber's Sociological Theory"],
  ...
  },
  {
    ...
    options: ["Casson's Economic Theory", "McCelland Theory of Achievement Motivation", "Knight Risk-bearing Theory", "Drucker's Theory"],
  ...
  },
  {
    ...
    options: ["Access to finance", "Government policy", "Social culture", "Technology"],
  ...
  },
  {
    ...
    options: ["Need for achievement and need for affiliation", "Need for money and need for fame", "Need for achievement and need for power", "Need for affiliation and need for power"],
  ...
  },
  {
    ...
    options: ["Max Weber", "Adam Smith", "Joseph Schumpeter", "Richard Cantillon"],
  ...
  },
  {
    ...
    options: ["Adam Smith", "John Campbell", "Franciousquesney", "Richard Cantillon"],
  ...
  },
  {
    ...
    options: ["Overregulation of foreign trade only", "Lack of funds and difficulty securing bank loans", "Excess government funding", "Too much infrastructure"],
  ...
  },
  {
    ...
    options: ["Legal regulation", "Political stability", "Ecological conditions", "Suppliers"],
  ...
  },
  {
    ...
    options: ["Legal Environment", "Customers", "Political Environment", "Ecological Environment"],
  ...
  },
  {
    ...
    options: ["To avoid paying taxes", "To increase interest rates", "To reduce advertising costs", "So goods can still be purchased if one supplier delays or stops supplying"],
  ...
  },
  {
    ...
    options: ["Economic Environment", "Socio-cultural Environment", "Legal Environment", "Political Environment"],
  ...
  },
  {
    ...
    options: ["Legal Environment", "Ecological Environment", "Socio-cultural Environment", "Political Environment"],
  ...
  },
  {
    ...
    options: ["Change resistance", "Diffusion theory", "Franchising", "Disruptive innovation"],
  ...
  },
  {
    ...
    options: ["NOTAP", "RMRDC", "NAFDAC", "FIRRO"],
  ...
  },
  {
    ...
    options: ["Outcomes", "Operations", "Objectives", "Opportunities"],
  ...
  },
  {
    ...
    options: ["Avoiding market research", "Reducing product quality", "Ignoring customer feedback", "Inefficiency in the market"],
  ...
  },
  {
    ...
    options: ["Identifying a perceived need of customers", "Government patent access", "Mass media advertising", "Franchising"],
  ...
  },
  {
    ...
    options: ["Weather risk", "Family risk", "Language risk", "Financial risk"],
  ...
  },
  {
    ...
    options: ["Employed and unemployed", "Educated and uneducated", "Rich and poor", "Playfulness and discipline"],
  ...
  },
  {
    ...
    options: ["Revolution", "Evolution", "Synthesis", "Reapplication"],
  ...
  },
  {
    ...
    options: ["Revolution", "Changing Direction", "Synthesis", "Evolution"],
  ...
  },
  {
    ...
    options: ["Physicists", "Government officials", "Aviation engineers", "Bicycle mechanics"],
  ...
  },
  {
    ...
    options: ["I might fail", "It can't be done", "What will people think?", "That's childish"],
  ...
  },
  {
    ...
    options: ["Patents and Trademarks", "Licenses and Assignments", "Trade Secrets and Royalties", "Industrial Property and Copyright"],
  ...
  },
  {
    ...
    options: ["RMRDC", "NOTAP", "Nigerian Copyright Commission (NCC)", "SMEDAN"],
  ...
  },
  {
    ...
    options: ["70 years", "50 years", "100 years", "25 years"],
  ...
  },
  {
    ...
    options: ["Trademark rights", "Patents", "Copyright", "Trade secrets"],
  ...
  },
  {
    ...
    options: ["Engineering", "Science", "Sociology", "Technology"],
  ...
  },
  {
    ...
    options: ["NOTAP", "Raw Material Research and Development Council (RMRDC)", "FIRRO", "Technology Incubation Centers (TIC)"],
  ...
  },
  {
    ...
    options: ["Sole proprietorship", "Franchising", "Biotechnology", "Trade unionism"],
  ...
  },
  {
    ...
    options: ["Government regulation", "Creativity", "Financing", "Marketing"],
  ...
  },
  {
    ...
    options: ["Diffusion Innovation", "Breakthrough Innovation", "Technological Innovation", "Ordinary Innovation"],
  ...
  },
  {
    ...
    options: ["A circular curve", "A 'V'-curve", "An 'S'-curve", "A straight line"],
  ...
  },
  {
    ...
    options: ["Personal hobbies", "Weather patterns", "Change in technology", "Family traditions"],
  ...
  },
  {
    ...
    options: ["Negotiation and Agreement", "Education and Communication", "Leadership", "Timing of Change"],
  ...
  },
  {
    ...
    options: ["Marketing succession", "Financial succession", "Management succession", "Ownership succession"],
  ...
  },
  {
    ...
    options: ["Fulfill a social mission", "Maximize personal wealth", "Avoid all risk", "Compete only with large corporations"],
  ...
  },
  {
    ...
    options: ["Reputation", "Feedback mechanism", "Resilience", "Knowledge management"],
  ...
  },
  {
    ...
    options: ["Religious beliefs", "Uninsurable risk", "Favourable economic conditions", "The need for affiliation"],
  ...
  },
  {
    ...
    options: ["Risk-bearing alone", "Government regulation", "Social culture", "Innovation resource and entrepreneurial behaviour"],
  ...
  },
  {
    ...
    options: ["The mercantilists", "The physiocrats", "The monetarists", "The Keynesians"],
  ...
  },
  {
    ...
    options: ["The mix of norms, values, and beliefs shared by a particular community", "A country's official language", "A government's economic policy", "A business's financial statements"],
  ...
  },
  {
    ...
    options: ["Desire for quick returns", "Excess of raw materials", "Overproduction", "Too many suppliers"],
  ...
  },
  {
    ...
    options: ["Customers", "Competitors", "Market intermediaries", "Financial intermediaries"],
  ...
  },
  {
    ...
    options: ["Political Environment", "Technological Environment", "Ecological Environment", "Economic Environment"],
  ...
  },
  {
    ...
    options: ["Never changes", "Usually becomes obsolete within a few months of being invented", "Cannot be patented", "Is always too expensive to adopt"],
  ...
  },
  {
    ...
    options: ["Socio-cultural Environment", "Legal Environment", "Economic Environment", "Ecological Environment"],
  ...
  },
  {
    ...
    options: ["Threats and weaknesses", "Strengths and weaknesses", "Strengths and opportunities", "Opportunities and threats"],
  ...
  },
  {
    ...
    options: ["Customer goodwill", "Adequate financial resources", "Outdated or obsolete facilities", "Strong management team"],
  ...
  },
  {
    ...
    options: ["Lack of competitors' interest", "High government taxation", "Currency devaluation", "Inefficiency in the market"],
    correctAnswer: "Inefficiency in the market",
  ...
  },
  {
    ...
    options: ["Competitor/Competitive Analysis", "Industry Analysis", "Risk Analysis", "Customer/Market Analysis"],
  ...
  },
  {
    ...
    options: ["RMRDC", "NOTAP", "FIRRO", "NAFDAC"],
    correctAnswer: "NAFDAC",
  ...
  },
  {
    ...
    options: ["Currency naming risk", "Weather forecasting risk", "Alphabet risk", "Technology risk"],
  ...
  },
  {
    ...
    options: ["Need for novel, varied, and complex stimulation", "Need to avoid all risk", "Need for large capital", "Need for approval from strangers"],
  ...
  },
  {
    ...
    options: ["Playfulness and discipline", "Aggression and secrecy", "Silence and isolation", "Laziness and confidence"],
    correctAnswer: "Playfulness and discipline",
  ...
  },
  {
    ...
    options: ["Synthesis", "Revolution", "Reapplication", "Evolution"],
    correctAnswer: "Synthesis",
  ...
  },
  {
    ...
    options: ["Synthesis", "Changing Direction", "Revolution", "Evolution"],
    correctAnswer: "Evolution",
  ...
  },
  {
    ...
    options: ["A university professor", "A printer's proofreader named Ladislao Biro", "An aviation engineer", "A mechanical engineer"],
  ...
  },
  {
    ...
    options: ["Lack of funding", "Excessive risk-taking", "Surrendering before the battle", "Overconfidence"],
  ...
  },
  {
    ...
    options: ["Industrial property and copyright", "Trademarks and patents only", "Personal property and real property", "Domestic property and foreign property"],
    correctAnswer: "Industrial property and copyright",
  ...
  },
  {
    ...
    options: ["Patents and Designs Act 1970", "TRIPS Agreement", "Copyright Act", "Trademarks Act 1965"],
  ...
  },
  {
    ...
    options: ["Nigerian Copyright Commission (NCC)", "NOTAP", "RMRDC", "NAFDAC"],
    correctAnswer: "Nigerian Copyright Commission (NCC)",
  ...
  },
  {
    ...
    options: ["Trademark rights", "Copyright", "Trade secret rights", "Patent rights"],
    correctAnswer: "Trademark rights",
  ...
  },
  {
    ...
    options: ["Patent law", "Right of publicity law", "Trade secret law", "Trademark law"],
  ...
  },
  {
    ...
    options: ["Abandonment", "Licensing", "Forfeiture", "Assignment"],
  ...
  },
  {
    ...
    options: ["Berne Convention", "TRIPS Agreement", "Paris Convention", "AU Model Law"],
  ...
  },
  {
    ...
    options: ["Know-how, skills and competence", "Government subsidies", "Marketing and sales only", "Foreign exchange rates"],
  ...
  },
  {
    ...
    options: ["WHO makes things happen", "WHY things happen", "HOW things happen", "WHEN things happen"],
  ...
  },
  {
    ...
    options: ["Failed company or product", "Rapidly expanding market", "Adaptation", "Brainstorming"],
  ...
  },
  {
    ...
    options: ["20-30 people, for a full day", "2-5 or 5-10 people, for 1-2 hours", "1 person, for 30 minutes", "50 people, for a week"],
  ...
  },
  {
    ...
    options: ["Election results", "Religious festivals", "Sources of Technology", "Family structure"],
  ...
  },
  {
    ...
    options: ["Technology Incubation Centers", "RMRDC", "NOTAP", "Federal Institute of Industrial Research, Oshodi (FIIRO)"],
  ...
  },
  {
    ...
    options: ["One year", "Ten years", "Indefinitely", "Three years"],
  ...
  },
  {
    ...
    options: ["Challenge", "Collaboration", "Communication", "Creativity"],
    correctAnswer: "Creativity",
  ...
  },
  {
    ...
    options: ["Completion", "Contemplation", "Culture", "Communication"],
  ...
  },
  {
    ...
    options: ["Creare", "Innovare", "Novum", "Inventio"],
  ...
  },
  {
    ...
    options: ["Radical Innovation", "Ordinary Innovation", "Technological Innovation", "Breakthrough Innovation"],
  ...
  },
  {
    ...
    options: ["Market-led or market-push innovation", "Random chance", "Government mandates", "Breakthrough scientific discovery"],
  ...
  },
  {
    ...
    options: ["Government subsidy", "Advertising budget", "Employee salary", "Communication Channels"],
  ...
  },
  {
    ...
    options: ["Weather", "Capital", "Sports", "Religion"],
  ...
  },
  {
    ...
    options: ["Economic Implications", "The Group Resistance", "Emotional Reasons", "Lack of Proper Communication"],
  ...
  },
  {
    ...
    options: ["Leadership", "Negotiation and Agreement", "Timing of Change", "Education and Communication"],
  ...
  },
  {
    ...
    options: ["A husband-wife team running the business together", "A publicly traded company", "A business with no family involvement", "A government-owned enterprise"],
  ...
  },
  {
    ...
    options: ["High employee turnover", "Loyalty", "Lack of trust", "Frequent lawsuits"],
  ...
  },
  {
    ...
    options: ["Financial", "Technological", "Political", "Ecological"],
  ...
  },
  {
    ...
    options: ["Reliance on familial ties", "Avoidance of savings", "Extravagant lifestyles", "An ascetic self-denial discouraging extravagance"],
  ...
  },
  {
    ...
    options: ["South American entrepreneurship", "Nordic entrepreneurship", "Asian entrepreneurship", "Western entrepreneurship"],
  ...
  },
  {
    ...
    options: ["Maximizes shareholder profit above all else", "Competes only for government contracts", "Achieves large scale, systematic and sustainable social change", "Avoids all forms of innovation"],
  ...
  },
  {
    ...
    options: ["Matching opportunity to mission", "Facilitating communication", "Advocacy for the poor", "Research, monitoring and evaluation"],
  ...
  },
  {
    ...
    options: ["The World Intellectual Property Organization", "The Global Good Fund Fellowship for Social Entrepreneurs", "The Social Entrepreneurship Accelerator at Duke (SEAD)", "The Schwab Foundation for Social Entrepreneurship"],
  ...
  },
  {
    ...
    options: ["Pure charitable donation with no expectation of return", "Sharing in the profits realized because they provide risk capital", "Tax evasion", "Government mandate"],
  ...
  },
  {
    ...
    options: ["Resilience", "Inputs", "Knowledge management", "Reputation"],
